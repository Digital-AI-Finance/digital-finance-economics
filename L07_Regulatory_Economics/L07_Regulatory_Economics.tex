...
\bottomnote{Stigler (1971): Regulation can serve public interest or private capture (regulatory capture: when regulators serve the industry they oversee instead of the public)---evidence determines which}
\end{frame}
...
Welfare means total economic value to society, combining consumer and producer surplus.
