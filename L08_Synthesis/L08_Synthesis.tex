...
\item CBDCs and central bank balance sheets
...
\item Order book vs. AMM mechanisms
\item MEV and information asymmetry
...
\bottomnote{Allen \& Gale (2000): Network structure determines contagion patterns; digital finance adds velocity}
\end{frame}
...
\item Bank runs (Diamond-Dybvig)
\end{itemize}

\vspace{0.3em}
\textbf{Allen \& Gale Framework}
\begin{itemize}
\item Complete vs. incomplete networks
\item Contagion depends on structure
\item Diversification can increase risk
\end{itemize}
...
\item Cross-platform contagion (CEX-DEX)
\end{itemize}
...
\bottomnote{Traditional finance and DeFi are converging through tokenization, institutional adoption, and regulatory clarity}
\end{frame}
...
\bottomnote{Rogers (1962) technology diffusion curves explain DeFi adoption; we are entering early majority phase}
\end{frame}
...
\item \textbf{Regulatory}: Privacy-AML trade-offs
\end{itemize}
...
\bottomnote{Similar to Mundell's impossible trinity, digital finance faces fundamental trade-offs between decentralization, efficiency, and security/compliance}
\end{frame}
...
\begin{itemize}
\item AML/CFT enforcement
\item Consumer protection
\item Systemic risk management
\end{itemize}
...
\item Platform competition with composability
\item DAO organizational economics
\end{itemize}
...
\item FSB (2023): ``High-Level Recommendations for Regulation of Crypto Assets''
\end{itemize}
