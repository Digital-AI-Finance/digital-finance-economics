...
> Smart contracts reduce Coasean transaction costs in four ways: (1) Search and information costs reduced by standardized templates; (2) Bargaining costs reduced by take-it-or-leave-it code; (3) Enforcement costs eliminated by automatic execution; (4) Counterparty risk reduced by trustless escrow. Total contracting cost reduction can be 90%+ for simple agreements.
