...
\bottomnote{Design choices involve trade-offs. Pareto frontier shows optimal trade-offs---no design can improve one attribute without sacrificing another. Dominated designs are inferior options.}
\end{frame}
