...
\item Lender of last resort in crises
\end{itemize}
...
\item Must hold reserves at central bank
\end{itemize}
...
\begin{itemize}
\item CBDC as outside option (an alternative that improves your bargaining power---if you can switch to CBDC, banks must treat you better)
...
Challenges:
\begin{itemize}
\item Digital divide persists \textit{(Example: In India, 300 million people lack smartphones---CBDC only on phones would exclude them, worsening inequality.)}
...
\bottomnote{Understanding these foundational terms is essential for analyzing CBDC policy}
\end{frame}
