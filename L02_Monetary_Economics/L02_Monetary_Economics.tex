...
\item Scalability trilemma (must sacrifice one of: decentralization, security, speed)
\end{itemize}
...
\item Correlation with risk assets---this undermines Bitcoin's ``digital gold'' claim since it doesn't protect portfolios during crashes
\end{itemize}
...
\item Declining over time (halvings: Bitcoin events that cut mining rewards in half every 4 years)
...
\begin{itemize}
\item Who captures monetary rents (profits from controlling money creation)?
